...
# Test logout
# NOTE: Must be in the same program with the login test since the connection channel should be the same. E.g. s.connect(("127.0.0.1",9000))
command = 0x232b # logout
print(command)
version = 1
clientType = 4
messageType = 0x0
