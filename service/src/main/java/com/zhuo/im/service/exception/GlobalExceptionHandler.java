package com.zhuo.im.service.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseVO unknownException(Exception e){
        ...
        /**
         * If there is an unknown exception, write the logic here and send emails or text messages.
         */
        return resultBean;
    }
    ...
    /**
     * Validator: Parameter verification exception handling
     *
     * @param ex
     * @return
     */
    ...
    public Object handleMethodArgumentNotValidException(ConstraintViolationException ex) {
        ...
        for (ConstraintViolation<?> constraintViolation : constraintViolations) {
            ...
            // Read the parameter field. constraintViolation.getMessage() reads the message value in the verification annotation
    ...
    public Object applicationExceptionHandler(ApplicationException e) {
        // Use a public result class to encapsulate the returned results. Here I specify the status code as
        ResponseVO resultBean =new ResponseVO();
    ...
    public Object  handleException2(BindException ex) {
        ...
        String message = "Parameter{".concat(err.getField()).concat("}").concat(err.getDefaultMessage());
        ResponseVO resultBean =new ResponseVO();
        resultBean.setCode(BaseErrorCode.PARAMETER_ERROR.getCode());
        resultBean.setMsg(message);
        return resultBean;
