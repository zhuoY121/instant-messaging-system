...
/**
 * @description Shared Thread Pool
 * @param
 * @return
*/
@Service
    ...
    public void submit(Runnable r) {
        ...
        threadPoolExecutor.submit(() -> {
            ...
            try {
                ...
                if (dur > 1000) {
                    logger.warn("ShareThreadPool executed taskDone, remnant num = {},slow task fatal warning,costs time = {},stack: {}", andDecrement, dur, stackTrace);
                } else if (dur > 300) {
                    logger.warn("ShareThreadPool executed taskDone, remnant num = {},slow task warning: {},costs time = {},", andDecrement,r, dur);
                } else {
                    logger.debug("ShareThreadPool executed taskDone, remnant num = {}", andDecrement);
                }
            }
        });
